...
class RecorderController {
    constructor(context, generator) {
        ...
        context.exposeBinding('performPlaywrightAction', (source, action) => this._performAction(source.frame, source.page, action)).catch(e => { });
        // Other non-essential actions are simply being recorded.
        context.exposeBinding('recordPlaywrightAction', (source, action) => this._recordAction(source.frame, source.page, action)).catch(e => { });
    ...
    async _performAction(frame, page, action) {
    ...
    async _recordAction(frame, page, action) {
